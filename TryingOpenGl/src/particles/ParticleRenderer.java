...
public class ParticleRenderer {
	...
	private static final int MAX_INSTANCES = 10000;   //Max ammount of particles that can be in one scene
	...
	protected ParticleRenderer(Loader loader, Matrix4f projectionMatrix){
		...
		loader.addInstancedAttribute(quad.getVaoID(), vbo, 5, 4, INSTANCE_DATA_LENGTH, 16);   //loading up textures
		loader.addInstancedAttribute(quad.getVaoID(), vbo, 6, 1, INSTANCE_DATA_LENGTH, 20);   //loading up blend factor
