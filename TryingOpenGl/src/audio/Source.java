...
public class Source {
	...
	public void setReferenceDifference(float referenceDistance) {
	...
	public void setLooping(boolean loop) {
		...
		//That last part is asking if loop is true-?- then set this param to AL10.AL_TRUE, else-:- set this param to AL10.AL_FALSE	
	}
